...
describe CatarseMercadopagos::Payment::MercadopagosController do

  describe "notifications" do
    it "should 404 status code when not passed the 'Notification' param" do
      post :notifications, {use_route: :catarse_mercadopagos}
      response.status.should == 404
    end

    it "should 200 status code when pass the 'Notification' param" do
      post :notifications, {Notificacion: fixture_file("mercadopagos_ipn_request.xml"), use_route: :catarse_mercadopagos}
    ...
    it "should confirm the backer" do
      ...
      stub_post("/Vender/Consulta_IPN.asp", "mercadopagos_ipn_response.xml", {:url => {:https => false}, country: MercadopagosCheckout::Configuration.country_name(::Configuration[:mercadopagos_country_id])})
      post :notifications, {Notificacion: fixture_file("mercadopagos_ipn_request.xml"), use_route: :catarse_mercadopagos}
      backer.reload
  ...
  describe "pay" do
    it "should redirect" do
      ...
      sign_in backer.user
      post :pay, {id: backer, use_route: :catarse_mercadopagos}
  ...
  describe "success" do
    it "should redirect to thank you path" do
      backer = Factory(:backer, confirmed: false)
      sign_in backer.user
      post :success, {id: backer, use_route: :catarse_mercadopagos}
  ...
  describe "error" do
    it "should redirect to new project backer path" do
      backer = Factory(:backer, confirmed: false)
      sign_in backer.user
      post :error, {id: backer, use_route: :catarse_mercadopagos}
